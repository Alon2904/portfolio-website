export const experience = [
    {
      ...
      description: [
        ...
        "Created seamless CRM integrations by refining project management workflows using TypeScript, GraphQL, Lambda, and AWS RDS.",
        "Collaborated with stakeholders in tech-related decision-making to ensure alignment with business objectives and technical feasibility."
      ],
    },
    {
